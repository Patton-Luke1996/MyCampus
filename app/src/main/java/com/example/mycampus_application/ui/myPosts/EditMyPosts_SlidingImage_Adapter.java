...
public class EditMyPosts_SlidingImage_Adapter extends PagerAdapter {
    private Context context;
    private ArrayList<String> IMAGES;
    private LayoutInflater inflater;

    EditMyPosts_SlidingImage_Adapter(Context context, ArrayList<String> IMAGES) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        View imageLayout = inflater.inflate(R.layout.layout_editmyposts_imageslider, container, false);
        assert imageLayout != null;

        final ImageView imageView = imageLayout.findViewById(R.id.userImage_editMyPosts);
